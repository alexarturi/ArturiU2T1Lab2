public class ChatBot {
    ...
    public void worstSubject(String yourSubject) {
        System.out.println("So, I hear that your least favorite subject is " + yourSubject + ".");
        System.out.println("I agree! I never liked " + yourSubject + " either.");
    }
}
